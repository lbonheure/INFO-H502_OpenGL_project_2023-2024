...
{
	std::cout << "Welcome in the sand box " << std::endl;
	std::cout << " This is a minimal code for sand box to view skeleton animation \n";
	...
	//Create the window
	GLFWwindow* window = glfwCreateWindow(width, height, "Simple project", nullptr, nullptr);
	if (window == NULL)
	{
		glfwTerminate();
	...
	* Include Shaders *
	*******************/
	const char sourceV_character[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/vertex_skinning.cpp";
	const char sourceF_character[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/fragment_skinning.cpp";

	Shader shader_character(sourceV_character, sourceF_character);

	std::cout << "char"<< std::endl;

	const char sourceV_ground[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/vertex_ground.cpp";
	const char sourceF_ground[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/fragment_ground.cpp";

	Shader shader_ground(sourceV_ground, sourceF_ground);

	std::cout << "ground"<< std::endl;
	
	const char sourceV_tree[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/vertex_tree.cpp";
	const char sourceF_tree[] = PATH_TO_SIMPLE_PROJECT_SHADERS "/fragment_tree.cpp";
