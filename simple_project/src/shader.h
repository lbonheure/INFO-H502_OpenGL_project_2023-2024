...
public:
    ...
    void setMatrix4Array(const GLchar* name, const std::vector<glm::mat4> matrix, uint size) {
        glUniformMatrix4fv(glGetUniformLocation(ID, name), size, GL_FALSE, glm::value_ptr(matrix[0]));
    }
